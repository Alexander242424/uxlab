    ...
    <div className="flex flex-col">
      <div className="w-full">
        ...
        <InfoBlock
          ...
          mobileDescription={["To increase daily engagement and provide", "meaningful value, Emma Sleep adopted a", "product-focused approach, redesigning the", "app to offer a comprehensive educational hub. "]}
        />
        ...
        <OverviewCaseTestimonialSection
          ...
          mobileText={["I'm consistently amazed", " at the quality of work", "Alex produces. From day", "one Alex just got our", "brand, created some", "stunning designs, and", "ensured the whole", "process ran smoothly."]}
        ...
        <InfoBlock
          ...
          mobileDescription={["Solution: Transforming the app into a","personalized educational hub"]}
        />
