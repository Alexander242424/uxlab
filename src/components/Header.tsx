          ...
          <div className="row">
            ...
            <div className="col-6 col-md-6  flex justify-between items-center">
              <nav className="hidden md:flex space-x-4 md:space-x-8 t-p1">
                {pathname === "/" ? (
                  <button
                    onClick={() => scrollToSection("services_list_section")}
                    className={`relative group header-text cursor-pointer ${activeSection === "services_list_section" ? "header-text-active" : ""
                      }`}
                  >
                    Services
                  ...
                  <Link
                    ...
                    className={`relative group header-text cursor-pointer ${pathname === "/" && activeSection === "services_list_section" ? "header-text-active" : ""
                      }`}
                  >
                    Services
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] header-underline underline-animation"></span>
              ...
              <div className="flex items-center ml-auto cursor-pointer">
                ...
                >
                  ...
                  <span className="relative">
                    ...
                    <span className="pr-7 pt-1 group-hover:pl-7 group-hover:pr-0 transition-all duration-300 t-p1">
                      Let’s Talk
                    </span>
                  </span>
                </div>
