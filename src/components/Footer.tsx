...
export default function Footer() {
    ...
    return (
        <footer className="mx-4 relative z-10 bg-black">
            ...
            >
                <div
                    className="container-fluid md:pb-10 pt-10 pb-[48px] sm:pb-[70px] text-text-700 sm:min-h-[calc(100dvh-400px)]">
                        ...
                        <div className="col-md-6 flex xl:gap-[154px]">
                            <div className="text-nowrap not-sm:min-w-1/2 md:pl-[1px] mb-8 md:mb-0 md:min-w-[212px]">
                                <ul className="space-y-4">
                                    ...
                                    <li>
                                        <Link href="/#services_list_section" className={`relative group text-text-700 t-p1`}
                                        > Services
                                            <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#fff] underline-animation"></span>
                                        </Link>
                                    </li>
