...
export default function HeroSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="hero_section mx-4 flex flex-col relative min-h-[calc(100vh-72px-230px)] sm:min-h-[calc(100vh-72px-120px)] lg:min-h-[calc(100vh-72px-140px)]"
    >
      <motion.div
      ...
      <div className="mt-auto pb-4 px-4 md:pb-10">
