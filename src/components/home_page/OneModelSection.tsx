...
export default function PackageCard({
  ...
  bullets = [
    ...
    "Analytics Tools Setup (optional)",
    "Conversion Rate (CR) Unlock",
    "Engagement Rate (ER) Uplift",
    "Average Order Value (AOV) Increase",
    "Live Time Value (LTV) Grow",
    "Add to Cart Rate (ATC) Raise",
    "Fast turnarounds, average every 48 hours.",
    "If we commit, we deliver it. No drama, no excuses.",
  ],
  ctaLabel = "Let’s Talk",
  onCtaClick,
  bannerImage,
